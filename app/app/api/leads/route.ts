...
<body style="margin:0;padding:0;background:#F8FAF3;font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;">
  <table width="100%" cellpadding="0" cellspacing="0" style="background:#F8FAF3;padding:40px 20px;">
    <tr>
      <td align="center">
        <table width="560" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 4px 24px rgba(47,62,51,0.08);">
          <!-- Header -->
          <tr>
          ...
          <!-- Footer -->
          <tr>
            <td style="padding:20px 40px 32px;border-top:1px solid #F3F6F4;">
              <p style="margin:0;font-size:12px;color:#8A8A8A;line-height:1.6;">
                Sarah Arnold, LPC-S · Restored Family Counseling · Austin, TX<br />
                <a href="mailto:sarah@austincliniciancircle.com" style="color:#5A7060;">sarah@austincliniciancircle.com</a>
              </p>
            </td>
          </tr>
        </table>
...
function buildNotificationEmail(firstName: string, email: string) {
  ...
  return `<!DOCTYPE html>
<html lang="en">
<body style="font-family:Helvetica,Arial,sans-serif;background:#f5f5f5;padding:32px 16px;">
  <table width="480" cellpadding="0" cellspacing="0" style="background:#fff;border-radius:12px;padding:28px 32px;box-shadow:0 2px 12px rgba(0,0,0,0.06);">
    <tr><td>
      <p style="margin:0 0 4px;font-size:11px;letter-spacing:1.5px;text-transform:uppercase;color:#8A8A8A;">New lead</p>
      ...
      <table cellpadding="0" cellspacing="0" style="width:100%;border-top:1px solid #eee;">
        <tr><td style="padding:10px 0;border-bottom:1px solid #eee;font-size:13px;color:#8A8A8A;width:120px;">Email</td>
            <td style="padding:10px 0;border-bottom:1px solid #eee;font-size:13px;color:#191C18;"><a href="mailto:${email}" style="color:#4A5D4E;">${email}</a></td></tr>
        <tr><td style="padding:10px 0;border-bottom:1px solid #eee;font-size:13px;color:#8A8A8A;">Source</td>
            <td style="padding:10px 0;border-bottom:1px solid #eee;font-size:13px;color:#191C18;">Coming soon — playbook download</td></tr>
        <tr><td style="padding:10px 0;font-size:13px;color:#8A8A8A;">Time (CT)</td>
