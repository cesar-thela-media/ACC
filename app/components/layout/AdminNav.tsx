...
export function AdminNav() {
  ...
  return (
    <>
      ...
      >
        <div>
          <p className="text-[11px] font-medium uppercase tracking-[0.24em]" style={{ color: "rgba(255,255,255,0.42)" }}>
            Admin
          </p>
          <span className="text-sm font-semibold" style={{ fontFamily: "var(--font-serif), Manrope, sans-serif", color: "#fff" }}>
      ...
      <MobileSidePanel
        ...
        title={
          <div>
            <p className="text-[11px] font-medium uppercase tracking-[0.24em] mb-2" style={{ color: "rgba(255,255,255,0.42)" }}>
              Admin
            </p>
      ...
      >
        ...
        <div className="mt-auto pt-6" style={{ borderTop: "1px solid rgba(255,255,255,0.14)" }}>
          <Link
            href={logoutHref}
            onClick={() => setMobileOpen(false)}
